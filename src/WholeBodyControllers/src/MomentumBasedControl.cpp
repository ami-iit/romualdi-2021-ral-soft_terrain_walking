...
using namespace SoftTerrainWalking::WholeBodyControllers;
...
{
    if (!m_controllers[WalkingState::DoubleSupport]->initialize(handler, "DOUBLE_SUPPORT"))
    {
    ...
    if (!m_controllers[WalkingState::SingleSupportLeft]->initialize(handler, "SINGLE_SUPPORT_LEFT"))
    {
