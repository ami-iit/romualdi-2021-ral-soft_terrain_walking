...
namespace WholeBodyControllersRigid
{
    template<class T>
        void copyDenseIntoSparse(const T& dense, const int& startingRow, const int& startingColumn,
                                 WalkingControllers::iDynSparseMatrix& sparse)
    {
    ...
    protected:
        ...
        WalkingControllers::iDynSparseMatrix m_jointRegularizationHessian; /**< Contains a constant matrix that can be useful
                                                          in the hessian evaluation ($-\lambda H' H$). */
        WalkingControllers::iDynSparseMatrix m_jointRegularizationGradient; /**< Contains a constant matrix that can be useful
        ...
        WalkingControllers::iDynSparseMatrix m_constraintsMatrixSparse; /**< Constraint matrix */
    ...
    public:
         ...
         */
        const WalkingControllers::iDynSparseMatrix& getConstraintMatrix() const;
