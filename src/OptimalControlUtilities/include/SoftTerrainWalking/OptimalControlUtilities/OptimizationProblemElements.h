...
#define SOFT_TERRAIN_WALKING_OPTIMAL_CONTROL_UTILITIES_OPTIMIZATION_PROBLEM_ELEMENTS_H
...
#endif // SOFT_TERRAIN_WALKING_OPTIMAL_CONTROL_UTILITIES_OPTIMIZATION_PROBLEM_ELEMENTS_H
