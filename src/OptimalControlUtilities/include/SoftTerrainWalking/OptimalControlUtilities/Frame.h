...
#define SOFT_TERRAIN_WALKING_OPTIMAL_CONTROL_UTILITIES_FRAME_H
...
class FrameInContactWithContactModel : public FrameInContact<T, U>
{
    ...
    std::shared_ptr<SoftTerrainWalking::ContactModels::ContinuousContactModel> m_contactModel{nullptr};
...
#endif // SOFT_TERRAIN_WALKING_OPTIMAL_CONTROL_UTILITIES_FRAME_H
