...
#define SOFT_TERRAIN_WALKING_OPTIMAL_CONTROL_UTILITIES_FLOATING_BASE_MULTI_BODY_DYNAMICS_ELEMENT_H
 ...
 * SoftTerrainWalking::OptimalControlUtilities::MultiBodyDynamicsElement the
...
#endif // SOFT_TERRAIN_WALKING_OPTIMAL_CONTROL_UTILITIES_FLOATING_BASE_MULTI_BODY_DYNAMICS_ELEMENT_H
