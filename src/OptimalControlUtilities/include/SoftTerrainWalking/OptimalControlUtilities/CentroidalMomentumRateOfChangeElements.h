...
#define SOFT_TERRAIN_WALKING_OPTIMAL_CONTROL_UTILITIES_CENTROIDAL_MOMENTUM_RATE_OF_CHANGE_ELEMENT
...
class CentroidalAngularMomentumRateOfChangeElement : public ControlTask
{
    ...
    iDynTree::Vector3 m_desiredAngularMomentumIntegral;
...
#endif // SOFT_TERRAIN_WALKING_OPTIMAL_CONTROL_UTILITIES_CENTROIDAL_MOMENTUM_RATE_OF_CHANGE_ELEMENT
