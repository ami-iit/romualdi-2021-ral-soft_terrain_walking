...
#define SOFT_TERRAIN_WALKING_OPTIMAL_CONTROL_UTILITIES_CENTROIDAL_MOMENTUM_ELEMENT_H
...
#endif // SOFT_TERRAIN_WALKING_OPTIMAL_CONTROL_UTILITIES_CENTROIDAL_MOMENTUM_ELEMENT_H
