...
void OrientationPID::evaluateControl()
{
    ...
    errorAttitude = WalkingControllers::iDynTreeUtilities::Rotation::skewSymmetric(
        m_orientation * m_desiredOrientation.inverse());
    ...
    dotError = iDynTree::unskew(iDynTree::toEigen(
        WalkingControllers::iDynTreeUtilities::Rotation::skewSymmetric(dotErrorAttitude)));
