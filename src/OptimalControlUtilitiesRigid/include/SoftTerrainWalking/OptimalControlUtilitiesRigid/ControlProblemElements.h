...
#define SOFT_TERRAIN_WALKING_OPTIMAL_CONTROL_UTILITIES_RIGID_CONTROL_PROBLEM_ELEMENTS_H
...
#include <SoftTerrainWalking/OptimalControlUtilitiesRigid/PID.h>
...
namespace OptimalControlUtilitiesRigid
{
    ...
    typedef struct
    {
        ...
        iDynTree::IndexRange indexRangeInElement{iDynTree::IndexRange::InvalidRange()}; /**< Index and size of the element in the ControlProblemElement */
    } Frame;
     ...
     * The Cartesian element in useful to control the position/orientation/pose of a frame/CoM of the robot
     */
    class CartesianElement : public CostFunctionOrEqualityConstraintElement
    {
    public:
        /** Cartesian Element Type */
        enum class Type {POSE, POSITION, ORIENTATION, ONE_DIMENSION};
    ...
    private:
        ...
        bool m_isInContact; /**< True if the frame if the link associated to the frame is in contact with the environment. */
    ...
    public:
         ...
         * @param frameName name of the frame that has to be controlled (if CoM the CoM will be controlled)
         * @param axisName X, Y or Z coordinate that will be controlled
         * @throw std::runtime_error in case of an undefined variable/frame
         */
        CartesianElement(iDynTree::KinDynComputations& kinDyn, const VariableHandler& handler,
                         const Type& type, const std::string& frameName, const AxisName& axisName = AxisName::X);
         ...
         */
        void setDesiredTrajectory(const iDynTree::Vector3& acceleration, const iDynTree::Vector3& velocity,
         ...
         */
        void setDesiredTrajectory(const iDynTree::SpatialAcc& acceleration, const iDynTree::Twist& velocity,
         ...
         */
        void setDesiredTrajectory(const double& acceleration, const double& velocity, const double& position);
         ...
         * @param isInContact true if the link associated to the frame is in contact with the environment
         */
    ...
    class SystemDynamicsElement : public CostFunctionOrEqualityConstraintElement
    {
        ...
        iDynTree::FreeFloatingGeneralizedTorques m_generalizedBiasForces; /**< Coriolis and Gravitational term  */
        iDynTree::MatrixDynSize m_jacobianMatrix; /**< Jacobian Matrix  */

        std::vector<Frame> m_framesInContact; /**< Vectors containing the frames in contact with the environment */
    ...
    public:
         ...
         * @param framesInContact vector containing the frames in contact. Each element of the vector is a pair
         * containing the name of the frame in the variableHandler and in the model.
         * @throw std::runtime_error if the frame is not defined
         */
        SystemDynamicsElement(iDynTree::KinDynComputations& kinDyn, const VariableHandler& handler,
         ...
         */
        [[deprecated ("This function is iCub specific. In the next implementation will be removed. If you want to include regularization element for the mass matrix please call SystemDynamicsElement(iDynTree::KinDynComputations&, const VariableHandler&, const std::vector<std::pair<std::string, std::string>>&, const iDyntree::MatrixDynsize&)")]]
        SystemDynamicsElement(iDynTree::KinDynComputations& kinDyn, const VariableHandler& handler,
                              const std::vector<std::pair<std::string, std::string>>& framesInContact,
    ...
    public:
         ...
         * @throw std::runtime_error if the frame is not defined
         */
        CentroidalLinearMomentumElement(iDynTree::KinDynComputations& kinDyn, const VariableHandler& handler,
    ...
    public:
         ...
         * @throw std::runtime_error if the frame is not defined
         */
        CentroidalAngularMomentumElement(iDynTree::KinDynComputations& kinDyn, const VariableHandler& handler,
                                         const std::vector<std::pair<std::string, std::string>>& framesInContact);
         ...
         */
        void setDesiredCentroidalAngularMomentum(const iDynTree::Vector3& centroidalAngularMomentumVelocity,
    ...
    public:
         ...
         */
        RegularizationElement(iDynTree::KinDynComputations& kinDyn, const VariableHandler& handler,
    ...
    /**
     * RegularizationWithControlElement describes an element used to regularize unknown variables using a control law
     * It is in general used as CostFunctionElement of the form  \f$ x^\top A^\top A x + g^\top x \f$
     */
    ...
    public:
         ...
         * @throw std::runtime_error if the variableName is not defined in the handler
         */
        RegularizationWithControlElement(iDynTree::KinDynComputations& kinDyn, const VariableHandler& handler,
                                         const std::string& variableName);
         ...
         * @param position desired position
         */
        void setDesiredTrajectory(const iDynTree::VectorDynSize& acceleration, const iDynTree::VectorDynSize& velocity,
    ...
    public:
         ...
         * @throw std::runtime_error if the frame is not defined
         */
        ZMPElement(iDynTree::KinDynComputations& kinDyn, const VariableHandler& handler,
                   const std::vector<std::pair<std::string, std::string>>& framesInContact);
    ...
    public:
         ...
         * @throw std::runtime_error if the frame is not defined
         */
        ContactWrenchFeasibilityElement(iDynTree::KinDynComputations& kinDyn, const VariableHandler& handler,
...
#endif // SOFT_TERRAIN_WALKING_OPTIMAL_CONTROL_UTILITIES_RIGID_CONTROL_PROBLEM_ELEMENTS_H
