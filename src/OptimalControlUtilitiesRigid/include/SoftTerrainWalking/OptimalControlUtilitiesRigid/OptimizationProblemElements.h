...
#define SOFT_TERRAIN_WALKING_OPTIMAL_CONTROL_UTILITIES_RIGID_OPTIMIZATION_PROBLEM_ELEMENTS_H
...
namespace OptimalControlUtilitiesRigid
{
    ...
    class Constraints
    {
        ...
        typedef struct EqualityConstraint
        {
             ...
             * Constructor
             */
            EqualityConstraint(CostFunctionOrEqualityConstraintElement * const element, const iDynTree::IndexRange& indexRange);
        } EqualityConstraint;
        ...
        typedef struct InequalityConstraint
        {
             ...
             * Constructor
             */
            InequalityConstraint(InequalityConstraintElement * const element, const iDynTree::IndexRange& indexRange);

        } InequalityConstraint;

        std::vector<EqualityConstraint> m_equalityConstrains; /**< Vector containing all the equality constraints */
        std::vector<InequalityConstraint> m_inequalityConstrains; /**< Vector containing all the inequality constraints */
    ...
    class CostFunction
    {
        ...
        typedef struct CostFunctionElement
        {
            ...
            double weightOffset{0}; /**< Offset of the weight i.e. Weight = weightScaling * customWeight + weightOffset */
            double weightScaling{1}; /**< Scaling factor of the weight i.e. Weight = weightScaling * customWeight + weightOffset */
    ...
    public:
         ...
         */
        const std::unordered_map<std::string, CostFunction::CostFunctionElement>& getCostFunctions() const;
    };
}
}
#endif // SOFT_TERRAIN_WALKING_OPTIMAL_CONTROL_UTILITIES_RIGID_OPTIMIZATION_PROBLEM_ELEMENTS_H
